<template>
  <div style="background-color:white">
    ...
    <div>Wisata Tujuan</div>
    <input type="text" class="todo-input" placeholder="Nama Wisata"
    ...
    <div class="extra-container">
        ...
        @change="checkAllTodos"> Sudah semua </label></div>
        <div>{{ remaining }} tujuan tersisa</div>
    </div>

    <div class="extra-container">
        <div>
            <button :class="{ active: filter == 'all' }" @click="filter = 'all'">Semua</button>
            <button :class="{ active: filter == 'active' }" @click="filter = 'active'">Belum Dikunjungi</button>
            <button :class="{ active: filter == 'completed' }" @click="filter = 'completed'">Sudah</button>
        </div>

        <div> 
            <button v-if="showClearCompletedButton" @click="clearCompleted">Bersihkan</button>
        </div>
